...
int main(){
    ...
    // cambiato view-order in check-order. cambiato add-customer in register-customer
    // cambiato add-purchase in make-order
    std::string req_types[num_types] = {"register-customer", "search-products", "make-order", "check-order", "review-order"};
